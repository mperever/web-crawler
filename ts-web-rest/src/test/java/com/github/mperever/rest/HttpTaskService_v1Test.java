...
import static com.github.mperever.rest.HttpTaskService_v1.RESULTS_SAVE_PATH;
import static com.github.mperever.rest.HttpTaskService_v1.SERVICE_ROOT_PATH;
import static com.github.mperever.rest.HttpTaskService_v1.TASKS_RETRIEVE_PATH;
...
public class HttpTaskService_v1Test extends JerseyTestNg.ContainerPerClassTest
{
    ...
    public void tasksRetrieve_should_return_tasks()
    {
        ...
        final Response serviceResponse = target( SERVICE_ROOT_PATH ).path( TASKS_RETRIEVE_PATH )
                .request()
                .post( Entity.entity( request, RESOURCE_MEDIA_TYPE ) );
    ...
    public void resultsSave_should_save_task_results()
    {
        ...
        final Response serviceResponse = target( SERVICE_ROOT_PATH ).path( RESULTS_SAVE_PATH )
                .request()
                .post( Entity.entity( request, RESOURCE_MEDIA_TYPE ) );
